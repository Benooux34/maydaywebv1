...
function Hero() {
  return (
    <section className="h-[85vh] flex items-center justify-center w-[95%] xl:w-[65%] text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-center font-bold">
